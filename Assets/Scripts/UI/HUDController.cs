...
public class HUDController : MonoBehaviour {
    ...
    private void OnNewLevelSelected(object sender,
        EventArgTemplate<LevelController> levelController) {
    ...
    private void OnHealthUpdated() {
        healthText.text = JoinFractionText(currentLevel.CurrentHealth,
            currentLevel.MaxHealth);
    }

    private void OnWaveUpdated() {
        waveText.text = JoinFractionText(currentLevel.CurrentWave,
            currentLevel.WaveCount);
    }
